...
app.post('/produto', async (req, resp) => {
    try {
        ...
        resp.send({ erro: 'Deu erro ao adicionar produto!' })
    }
}) 
...
app.put('/produto/:id', async (req, resp) => {
    try {
        ...
        resp.send({ erro: 'Deu erro ao tentar alterar produto' })
    }
}) 
...
app.delete('/produto/:id', async (req, resp) => {
    try {
        ...
        resp.send({ erro: 'Deu erro no ao tentar deletar produto !' })
    }
}) 


app.listen(process.env.PORT,
            x => console.log(`Opa subiu nossa API ${process.env.PORT}`))